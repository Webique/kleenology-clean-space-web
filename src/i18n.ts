    ...
    translation: {
      ...
      services: {
        ...
        descriptions: {
          ...
          'Appliance Cleaning': 'Detailed cleaning of ovens, refrigerators, dishwashers, and small appliances inside and out.',
      ...
      about: {
        ...
        features: [
          ...
          },
          {
            ...
            desc: 'فريقنا تم فحص خلفيته ومدرب تدريباً عالياً.'
          },
          {
            title: 'صديق للبيئة',
            desc: 'نستخدم منتجات آمنة وصديقة للبيئة لعائلتك وكوكب الأرض.'
          },
          {
            title: 'تسعير شفاف',
            desc: 'لا توجد رسوم خفية. عروض أسعار واضحة ومقدمة.'
          }
        ]
      },
      services: {
        ...
        descriptions: {
          ...
          'تنظيف الأجهزة': 'تنظيف تفصيلي للأفران، الثلاجات، غسالات الصحون، والأجهزة الصغيرة من الداخل والخارج.',
